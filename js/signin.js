...
angular.module('signin', ['ngAnimate'])
.service('signin', ['$rootScope', function ($rootScope) {
...
applic.controller("signin",['$scope','$http','$interval','$location','$anchorScroll',function($scope,$http,$interval,$location,$anchorScroll){
